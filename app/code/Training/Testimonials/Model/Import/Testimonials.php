 ...
 * Class Testimonials
 */
class Testimonials extends AbstractEntity
{
    const TABLE = 'testimonials';
    const ENTITY_ID_COLUMN = 'id';
    const ENTITY_CODE = 'testimonials';
    ...
    public function validateRow(array $rowData, $rowNum)
    {
        ...
        $duration = $rowData['testimonial_text'] ?? '';
        ...
        if (!$duration) {
            $this->addRowError('TestimonialTextIsRequired', $rowNum);
        }
    ...
    private function initMessageTemplates()
    {
        $this->addMessageTemplate(
            'FullNameIsRequired',
            __('The full name cannot be blank.')
        );
        $this->addMessageTemplate(
            'TestimonialTextIsRequired',
            __('Testimonial Text cannot be blank.')
        );
    }
}
